...
#[AsCommand(name: 'planning:make:entity', description: 'Génère une entité concrète de Slot qui étend AbstractSlot, avec traits & mapping Doctrine.')]
class MakePlanningEntityCommand extends Command
{
